...
public class BadWord {
    ...
    public final String[] basicResource = {
            ...
            "후장", "후장꽂아", "후장뚫어", "흐접", "흐젚", "흐졉", "bitch", "fuck", "fuckyou", "nflavor", "penis", "pennis", "pussy", "sex", "사발", "싸발", "싸발넘", "싸발련",
            "싸발세끼", "싸발놈", "싸발년", "씹련"
    };

    public Stream<String> getBadWords() {
        return Arrays.stream(basicResource);
    }
}
